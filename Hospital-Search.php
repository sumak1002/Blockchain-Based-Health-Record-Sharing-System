...
<input type="search" class="form-control" name="username" placeholder="Search By Hospital" required><br>
<input type="submit" required class="btn btn-primary" value="Search">
   </form>   <br><br>         
         
<?php function longenough($word){
...
$query = "SELECT * FROM hospital where treatment like '%$value%' OR full_name like '%$value%'";
